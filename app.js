...
form.addEventListener("submit", function (event) { return __awaiter(_this, void 0, void 0, function () {
    var name, email, contactNumber, subject, message, emailPattern, contactPattern, formData, response, result, errorText, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 1:
                _a.trys.push([1, 7, , 8]);
                return [4 /*yield*/, fetch("http://localhost:3000/contactUs", {
                        method: "POST",
                        headers: {
